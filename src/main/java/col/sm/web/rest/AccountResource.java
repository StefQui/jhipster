...
import col.sm.domain.PersistentToken;
import col.sm.domain.User;
import col.sm.repository.PersistentTokenRepository;
import col.sm.repository.UserRepository;
import col.sm.security.SecurityUtils;
import col.sm.service.MailService;
import col.sm.service.UserService;
import col.sm.service.dto.UserDTO;
import col.sm.web.rest.vm.KeyAndPasswordVM;
import col.sm.web.rest.vm.ManagedUserVM;
